"""
Original Perth Housing Price Prediction Code
This file contains the original code as provided by the user.
"""
...
# Remove $ signs, commas, tabs and convert to numeric
for year in years:
    df[year] = df[year].astype(str)            # Ensure it's string
    df[year] = df[year].str.replace(r'[\$, \t]', '', regex=True)  # Remove $, spaces, tabs
...
#average house price of suburb 2025-2025
